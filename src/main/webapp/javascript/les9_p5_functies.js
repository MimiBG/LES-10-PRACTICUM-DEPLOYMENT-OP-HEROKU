...
function addRegisterForm(){
	...
	document.getElementById("wijzigGegevens").innerHTML += '<input name="email" type="email" value="" required>EMAIL<br><br>';
	document.getElementById("wijzigGegevens").innerHTML += '<input name="telefoonnummer" type="number" value="" required>TELEFOONNUMMER<br><br>';
	document.getElementById("wijzigGegevens").innerHTML += '<input name="adres" type="text" value="" required>ADRES<br><br>';
	document.getElementById("wijzigGegevens").innerHTML += '<input name="role" type="text" value="user" readonly>ROLE<br><br>';
	document.getElementById("wijzigGegevens").innerHTML += '<input type="button" id="register" value="Registreer"><br><br>';
...
function registerFunc(){
    ...
    fetch("restservices/accountss", { method: 'POST', body: encData, headers: {'Authorization': 'Bearer ' + window.sessionStorage.getItem("myJWT")} })
    	.then(response => response.json())
    	.then(function (myJson) { console.log(myJson); });
//    	.then(function (myJson){
  //  		if (response.ok)
    //			console.log("Account added to database!");
    	//	else console.log(myJson);
    	//})
}

var registreer = document.querySelector("#registreer");
registreer.addEventListener("click", addRegisterForm);
